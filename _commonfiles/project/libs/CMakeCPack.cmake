...
set(CPACK_COMPONENT_DEV_DISPLAY_NAME "Development components")
set(CPACK_COMPONENT_DEV_DEPENDS runtime)

set(CPACK_PACKAGE_NAME "${PROJECT_NAME}${EG_PACKAGE_DEBUG}")
...
if (("${EG_CPACK_GENERATOR}" STREQUAL "DEB") OR ("${EG_CPACK_GENERATOR}" STREQUAL "RPM"))
	include(packages/CMakeCPackDeb.cmake)
	add_custom_target(pkg DEPENDS deb_runtime deb_dev)
else()
